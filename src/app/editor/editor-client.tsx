...
function EditorPageContent({ session }: EditorPageClientProps) {
  const {
    title,
    setTitle,
    content,
...
export default function EditorPageClient({ session }: EditorPageClientProps) {
  return (
    <Suspense fallback={
      ...
      <EditorPageContent session={session} />
    </Suspense>
  );
}
